<template>
  ...
  <nut-popup v-model:visible="showchixu" position="bottom" :style="{ height: '41%' }" :z-index="100" :round="true">
    <div
    ...
    <div style="display: flex; padding: 71rpx 40rpx; justify-content: space-between">
      <nut-button style="width: 322rpx" type="default">取消</nut-button
      ><nut-button color="#008EE5" style="width: 322rpx" type="info">确认</nut-button>
    </div>
  </nut-popup>
</template>
